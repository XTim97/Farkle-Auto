...
export default function ScoreButtons({ disabled, onAddScoringAction, onAutoRoll, autoRollDisabled }) {
  return (
    <section className="score-buttons">
      ...
      <button
        type="button"
        className="score-button auto-roll-grid-button"
        onClick={onAutoRoll}
        disabled={autoRollDisabled}
      >
        <span className="score-button-label">🎲 Auto Roll</span>
      </button>
    </section>
  );
}
